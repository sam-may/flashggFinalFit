...
for coupling in couplings:
    ...
    command = "python makeSplusBModelPlot.py --inputWSFile FinalResults/Datacard_%s_%s_FCNC.root --cat %s --doZeroes --parameterMap r_fcnc_%s:%.6f" % (args.tag, coupling.lower(), "all", coupling.lower(), limits[coupling])
    command_list.append(command)
